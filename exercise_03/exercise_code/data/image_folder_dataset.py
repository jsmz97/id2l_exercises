...
class ImageFolderDataset(Dataset):
    ...
    def make_dataset(directory, class_to_idx):
        ...
        :returns: (images, labels) where:
            ...
            - labels is a list containing one label per image
              labels[i] = the class the image[i] belongs to !
        """
        images, labels = [], []
        ########################################################################
        # TODO:                                                                #
        ...
        # Call the static method from above
        # classes, class_to_idx = _find_classes(directory)
        # Not needed here because class_to_idx and directory are in constructor!
        
        for cls in class_to_idx:
            cls_path = os.path.join(directory, cls)
            for index, image in enumerate(sorted(os.listdir(cls_path))):
    ...
    def load_image_as_numpy(image_path):
        ...
        # Hint: Image_path here is images[index] !
    ...
    def __getitem__(self, index):
        ...
        label_dict = {"label":self.labels[index]}
        
        # Merge two dicts (ONLY for Python 3.5+)
        data_dict = {**image_dict, **label_dict}
