...
class RegressionNet(Network):
    ...
    def forward(self, X):
        ...
        out_1, cache_affine1 = affine_forward(X,W1,b1)
        out_2, cache_sigmoid = sigmoid_forward(out_1)
        y, cache_affine2 = affine_forward(out_2,W2,b2)
    ...
    def backward(self, dy):
        ...
        dy, dW2, db2 = affine_backward(dy, cache_affine2)
        dy = sigmoid_backward(dy, cache_sigmoid)
        dout, dW1, db1 = affine_backward(dy, cache_affine1)
